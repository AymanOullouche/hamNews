...
public class ArticleListView extends Application {
    ...
    private StackPane createFormAndBackground() {
        // Image backgroundImage = new Image("com/hamNews/Views/images/flow.jpg");
        Image backgroundImage = new Image(
                getClass().getResource("/com/hamNews/Views/images/flow.jpg").toExternalForm());
        ImageView backgroundImageView = new ImageView(backgroundImage);
        backgroundImageView.setFitWidth(1150);
        backgroundImageView.setFitHeight(550);

        // Image formImage = new Image("com/hamNews/Views/images/LoginBack.png");
        Image formImage = new Image(getClass().getResource("/com/hamNews/Views/images/LoginBack.png").toExternalForm());
    ...
    private VBox createMainInterface() {
        ...
        // Image likeImage = new Image("com/hamNews/Views/images/like.png");
        Image likeImage = new Image(getClass().getResource("/com/hamNews/Views/images/like.png").toExternalForm());
        ImageView likeImageView = new ImageView(likeImage);
        likeImageView.setFitWidth(40);
        likeImageView.setFitHeight(40);

        // Image downloadImage = new Image("com/hamNews/Views/images/download.png");
