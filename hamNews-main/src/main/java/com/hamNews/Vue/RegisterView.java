...
public class RegisterView extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        registerButton.setStyle("-fx-background-color: #3498db; -fx-text-fill: white; -fx-font-size: 16; -fx-font-weight: bold;");
        ...
        VBox formLayout = new VBox(15, banner, appImageView, welcomeText, firstNameField, lastNameField, emailField, passwordField, registerButton, bottomLinkBox);
    ...
    private TextField createCustomTextField(String placeholder) {
        ...
        textField.setStyle("-fx-font-size: 14; -fx-padding: 10; -fx-border-color: #bdc3c7; -fx-border-radius: 5; -fx-background-radius: 5;");
    ...
    private PasswordField createCustomPasswordField(String placeholder) {
        ...
        passwordField.setStyle("-fx-font-size: 14; -fx-padding: 10; -fx-border-color: #bdc3c7; -fx-border-radius: 5; -fx-background-radius: 5;");
        passwordField.setMaxWidth(500);
        passwordField.setPrefHeight(40);
        return passwordField;
    }

    private void handleRegister(TextField firstNameField, TextField lastNameField, TextField emailField, PasswordField passwordField) {
