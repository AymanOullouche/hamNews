...
public class LoginView extends Application {
    ...
    public void showLoginInterface(Stage primaryStage) {
        ...
        loginButton.setStyle("-fx-background-color: #2980b9; -fx-text-fill: white; -fx-font-size: 14px; -fx-padding: 10;");
        loginButton.setPrefWidth(200);
        loginButton.setFocusTraversable(true);
        Image Danger = new Image("com/hamNews/Vue/images/alerte.png");
    ...
    private void openSignUpForm() {
        ...
        signUpFields = new VBox(15, signUpTitle, nameField, surnameField, emailField, signUpPasswordField, signUpCPasswordField, registerButton,MessageE,errorHBox);
    ...
    private void handleRegister(TextField firstNameField, TextField lastNameField, TextField emailField, PasswordField passwordField, PasswordField confirmPasswordField) {
